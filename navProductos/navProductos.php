      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="../usuario/domicilio.php">Datos personales</a></li>
            <li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="../carrito/carrito.php"><i class="fa-solid fa-cart-shopping"></i> Mi carrito </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../comprar/misCompras.php">Mis compras</a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Productos en venta
